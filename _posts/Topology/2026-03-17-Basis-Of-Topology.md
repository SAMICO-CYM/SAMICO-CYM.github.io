...
## Definition
A ***basis*** on a set $X$ is a collection $\mathcal{B}$ of subsets of $X$ such that
...
Let $\mathcal{B}$ be a basis on a set $X$. Then the collection 

$$\mathcal{T} _ { \mathcal{B} } = \{ U \subset X \mid \forall x \in U, \exists B_x \in \mathcal{B} \, [x \in B_x \subset U] \}$$

is a topology on $X$. In this case, we say that $\mathcal{T} _ { \mathcal{B} }$ is ***the topology generated by a basis $\mathcal{B}$***, or $\mathcal{B}$ is ***a basis for a topology*** on $X$. 
