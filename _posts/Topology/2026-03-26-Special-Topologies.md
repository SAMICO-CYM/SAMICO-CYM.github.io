...
**(iii)** Let $\mathcal{B}'' = \\{ (a,b), (a, b) \setminus K \mid a, b \in \mathbb{R} \\}$ where $K = \left\\{  \frac{1}{n} \mid n \in \mathbb{N} \right\\}$. Then the topology generated by $\mathcal{B}''$ is called the ***$K$-topology*** on $\mathbb{R}$. We denote $\mathbb{R}_{K} = (\mathbb{R}, \mathcal{T} _{\mathcal{B}''})$.
